...
public class AEController extends AEBaseController {
     ...
     * @return
     */
    @RequestMapping(value = "/stats/summary/{" + AEConstants.BUCKET + "}", method = RequestMethod.GET,produces = "application/json;charset=utf-8")
    @ResponseBody
    public Object getSummary(@PathVariable(AEConstants.BUCKET) String bucket, HttpServletRequest request, HttpServletResponse response) {
       ...
       Object obj = this.doProcess(bucket, request);
        return obj;
    }
     ...
     * @return
     */
    @RequestMapping(value = "/stats/groupBy/{" + AEConstants.BUCKET + "}", method = RequestMethod.GET,produces = "application/json;charset=utf-8")
    @ResponseBody
